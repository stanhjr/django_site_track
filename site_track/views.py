...
from site_track.forms import UserSignUpForm, LoginForm, ResetPasswordForm, RestorePasswordForm
from site_track.models import MyUser
from site_track.tools.send_email import generate_key, send_reset_password_link_to_email
...
class FollowEmail(TemplateView):
    template_name = 'follow_email.html'
